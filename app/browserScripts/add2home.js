...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			zh_cn: '将本页保存到桌面，以后学习更方便<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. 点击下方%icon按钮<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 选择<strong>添加至主屏幕</strong>',
	...
	function loaded () {
		if(location.href.split('center/study').length>=2){
			return;
		}
		...
		if ( options.touchIcon ) {
			...
			if ( touchIcon ) {
				touchIcon = '<span style="background-image:url(img/bubble.png)" class="addToHomeTouchIcon"></span>';
			}
		}
